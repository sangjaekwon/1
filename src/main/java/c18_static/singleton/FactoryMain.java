...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        SmartPhone smartPhone1 = factory1.produceSmaartPhone();
        SmartPhone smartPhone2 = factory2.produceSmaartPhone();
        SmartPhone smartPhone3 = factory3.produceSmaartPhone();
        SmartPhone smartPhone4 = factory4.produceSmaartPhone();
